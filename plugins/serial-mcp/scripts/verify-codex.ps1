...
$expectedArgs = @("--from", "git+https://github.com/JOCOIN94/serial-mcp-server@v1.19.7", "serial-mcp")
...
Write-Host "ok: Codex MCP '$Name' -> uvx --from git+https://github.com/JOCOIN94/serial-mcp-server@v1.19.7 serial-mcp"
if ($isDirect) {
