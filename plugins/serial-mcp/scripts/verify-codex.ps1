...
$expectedArgs = @("--from", "git+https://github.com/JOCOIN94/serial-mcp-server@v1.12.3", "serial-mcp")
...
Write-Host "ok: Codex MCP '$Name' -> uvx --from git+https://github.com/JOCOIN94/serial-mcp-server@v1.12.3 serial-mcp"
if ($isDirect) {
