...
$expectedArgs = @("--from", "git+https://github.com/JOCOIN94/silotek-serial-mcp", "serial-mcp")
...
Write-Host "ok: Codex MCP '$Name' -> uvx --from git+https://github.com/JOCOIN94/silotek-serial-mcp serial-mcp"
if ($isDirect) {
