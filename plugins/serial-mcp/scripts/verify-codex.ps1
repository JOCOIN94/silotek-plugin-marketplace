...
$expectedArgs = @("--from", "git+https://github.com/JOCOIN94/serial-mcp-server@v1.11.0", "serial-mcp")
...
Write-Host "ok: Codex MCP '$Name' -> uvx --from git+https://github.com/JOCOIN94/serial-mcp-server@v1.11.0 serial-mcp"
if ($isDirect) {
